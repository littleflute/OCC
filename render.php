...
function renderPageBegin($pagetitle,$class,$links,$title)
{
	...
	if ($pagetitle == 'OCC - Overview') echo '<meta http-equiv="refresh" content="20">'; // Sergei Ki
	echo	'<meta http-equiv=Content-Type content="text/html; '.
		'charset=utf-8"></HEAD><BODY>';
	echo '<DIV align="center">';
	echo '<P>'; if ($pagetitle!='') echo '<IMG alt="" src="images/'.$theme.'/logo.jpg">'; echo '<BR><BR>'; // Sergei Ki <BR>
	if ($links) {
		echo '[ ';
		$i=0;
